...
**Full technical reference:** [`docs/secure_android_vm.pdf`](docs/secure_android_vm.pdf) — covers requirements, security architecture, design, implementation, LLVM obfuscation layer, asset generation, usage, CI pipeline, and binary blob format specifications.
